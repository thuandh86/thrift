...
ACLOCAL = ${SHELL} /media/Data1/Project/Cloud/thrift-0.9.3/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
...
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /media/Data1/Project/Cloud/thrift-0.9.3/missing autoconf
AUTOHEADER = ${SHELL} /media/Data1/Project/Cloud/thrift-0.9.3/missing autoheader
AUTOMAKE = ${SHELL} /media/Data1/Project/Cloud/thrift-0.9.3/missing automake-1.14
AWK = mawk
BISON = bison
BOOST_CHRONO_LDADD = /usr/local/lib/libboost_chrono.a
BOOST_CPPFLAGS = -I/usr/local/include
BOOST_FILESYSTEM_LDADD = /usr/local/lib/libboost_filesystem.a
BOOST_LDFLAGS = -L/usr/local/lib
BOOST_LIB_DIR = /usr/local/lib
BOOST_SYSTEM_LDADD = /usr/local/lib/libboost_system.a
BOOST_TEST_LDADD = /usr/local/lib/libboost_unit_test_framework.a
BOOST_THREAD_LDADD = /usr/local/lib/libboost_thread.a
BUNDLER = 
CABAL = true
...
LD = arm-linux-androideabi-ld -m elf_x86_64
LDFLAGS = 
LEX = flex
LEXLIB = -lfl
...
LUA_SHORT_VERSION = 
LUA_VERSION = 
MAKEINFO = ${SHELL} /media/Data1/Project/Cloud/thrift-0.9.3/missing makeinfo
MANIFEST_TOOL = :
MAYBE_CPP = cpp
MAYBE_CSHARP = 
MAYBE_C_GLIB = c_glib
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /media/Data1/Project/Cloud/thrift-0.9.3/lib/erl
abs_srcdir = /media/Data1/Project/Cloud/thrift-0.9.3/lib/erl
abs_top_builddir = /media/Data1/Project/Cloud/thrift-0.9.3
abs_top_srcdir = /media/Data1/Project/Cloud/thrift-0.9.3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /media/Data1/Project/Cloud/thrift-0.9.3/install-sh
